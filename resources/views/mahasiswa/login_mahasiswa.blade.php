...
<head>
    ...
    <title>Login Mahasiswa - E-Rapot</title>
    ...
    <div class="login-card">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 p-5">
                <h2 class="fw-bold mb-4 text-center">Login Mahasiswa</h2>
                ...
                <form action="/mahasiswa/login" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label">NRP (Nomor Registrasi Mahasiswa)</label>
                        <input type="text" name="nrp" class="form-control custom-input" placeholder="Contoh: 50252XXXX" value="{{ old('nrp') }}" required autofocus>
                    </div>
                    ...
                    <div class="text-center mt-3">
                        <small>Belum punya akun Portal Mahasiswa? <a href="{{ route('mahasiswa.register') }}" class="fw-bold text-decoration-none" style="color: #0ea5e9;">Daftar Sekarang</a></small>
                    </div>
                </form>
            </div>
            
            <div class="col-md-6 d-none d-md-block text-center bg-light p-5 rounded-end">
